...
lint-flake8:
	...
	@$(POETRY) run flake8 aioaerospike
	@echo "\033[92m> done\033[0m"
	@echo
...
lint-mypy:
	...
	@$(POETRY) run mypy --ignore-missing-imports --follow-imports=silent aioaerospike
	@echo "\033[92m> done\033[0m"
	@echo
...
.PHONY: test
test:
	@$(POETRY) run pytest --cov-report term --cov-report html --cov=aioaerospike -vv
